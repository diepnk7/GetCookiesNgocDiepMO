...
(() => {
  let timePerAction = prompt("Time per action(1s = 1000 ms):", "1500");
  let totalFriendRequestsSent = prompt("Number of friend:", "100");
  ...
  console.log(`Friend requests remanding: ${totalFriendRequestsSent}`);
   // the number of users you want to send friend requests
